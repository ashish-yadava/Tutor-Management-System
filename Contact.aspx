            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Our Address</h3>
                  <p>Noida IT Park, Uttar Pradesh, NOIDA 201301</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
              ...
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Call Us</h3>
                  <p>+91 7897XXXX59<br>+91 7651XXXX77</p>
                </div>
              </div>
            </div>
            ...
            <%--<form action="forms/contact.php" method="post" role="form" class="php-email-form">--%>
              <div class="form-row">
                ...
                <div class="col-md-6 form-group">
                  ...
                  <asp:TextBox ID="EmailTextBox" Class="form-control" placeholder="Your Email" runat="server"></asp:TextBox>
                    ...
                    <asp:regularexpressionvalidator ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="EmailTextBox" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="regularexpressionvalidator1" runat="server" ErrorMessage="Invalid Email"></asp:regularexpressionvalidator>
                    <%--<div class="validate"></div>--%>
                </div>
              </div>
              ...
              <div class="form-group">
                <%--<textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>--%>
                  <asp:TextBox ID="MessageTextBox" TextMode="MultiLine" placeholder="Enter Message" Columns="62" Rows="5" runat="server"></asp:TextBox>
