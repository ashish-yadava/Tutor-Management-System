    ...
    <div class="container" style="-webkit-box-shadow: -2px 2px 29px 1px rgba(0,0,0,0.75);
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <asp:RangeValidator ID="RangeValidator1" ControlToValidate="AgeTextBox" ForeColor="Red" SetFocusOnError="true" MaximumValue="60" MinimumValue="5" Type="Integer" Display="Dynamic" runat="server" ErrorMessage="Age Should be Within 5 to 60"></asp:RangeValidator>
                <br />
            ...
            <div class="col-md-4">
                ...
                <asp:RequiredFieldValidator InitialValue="Select Tution Type" ControlToValidate="TutionTypeDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator13" runat="server" ErrorMessage="Tution Type is Required"></asp:RequiredFieldValidator>                                           
                <br />
                ...
                <asp:RequiredFieldValidator InitialValue="Select Tutor Preferred" ControlToValidate="TutorPreferDropDownList" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator14" runat="server" ErrorMessage="Select Preferred is Required"></asp:RequiredFieldValidator>                                           
                <br />
